...
| **Slice** | **R1 placement closure — done** (`cursor/cp-g2a-r1-placement-closure-13bb`, proof `Docs/QA/G2/cp-g2a/r1-placement-closure.md`). **R2 construction integrity — in progress** (`cursor/cp-g2a-r2-construction-integrity-a2b9`, proof `Docs/QA/G2/cp-g2a/r2-proof/`). Placement-mode exit from R1 is **not** reopened. |
