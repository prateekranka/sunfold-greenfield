 ...
 * @property {number} [flareCoronaOpacity]
 * @property {number} [haloSize]
 * @property {number} [haloColor]
 * @property {number} [haloOpacity]
 * @property {number} [limbColor]
 * @property {number} [limbOpacity]
 * @property {number} [glareColor]
 * @property {number} [glareSize]
 * @property {number} [glareOpacity]
 * @property {number} [sparkColor]
 * @property {number} [sparkCount]
 * @property {number} [sparkInnerRadius]
 * @property {number} [sparkOuterRadius]
 * @property {number} [sparkSize]
 * @property {number} [sparkOpacity]
